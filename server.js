...
app.use(express.static(__dirname)); // serves /church.html from root directory

// CORS middleware for the image proxy
...
app.listen(PORT, () =>
  console.log(`Open http://localhost:${PORT}/church.html (or / if named index.html)`)
);